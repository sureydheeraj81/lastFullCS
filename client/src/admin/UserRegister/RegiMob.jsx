...
const RegiMob = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/addUser/cors-sendOtp', data);
            ...
            if (response.data.success === true) {
                ...
                navigate('/mobverify', { state: { region, mobile_no } })
    ...
    //     setIsCaptchaValid(validateCaptcha(captchaValue));
    //   };

    // const handleSubmit = (e) => {
    // e.preventDefault();
    // if (isCaptchaValid) {
    //     console.log("Form submitted", { region, mobileNo });
    // }
    // };
            ...
            <div className="container clear">
                ...
                <div className="row">
                    <div className="col-md-6" style={{ marginTop: '50px' }}>
                        ...
                        >
                            <h5>Select Region</h5>
                            <input className="custom_input" type="hidden" name="token" />
                            <label>Region</label>
                            ...
                            <input
                                type="submit"
                                className="btn custom-sub-btn bg-success btn-lg"
                                value="Proceed"
                                id="submit-btn"
